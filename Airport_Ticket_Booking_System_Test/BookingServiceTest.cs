// File: Airport_Ticket_Booking_System_Test/BookingServiceTests.cs
using System;
using System.Linq;
using Xunit;
...
namespace Airport_Ticket_Booking_System_Test
{
    public class BookingServiceTests
    {
        ...
        {
            // Create a flight with all required properties.
            var flight = new Flight("FL001", "USA", "Canada", "JFK", "YYZ", DateTime.UtcNow, new Dictionary<string, decimal> { { "Economy", 500M } });
        ...
        public void ModifyBooking_ShouldUpdateBooking()
        {
            ...
            var flight2 = new Flight("FL002", "UK", "France", "LHR", "CDG", DateTime.UtcNow.AddDays(1), new Dictionary<string, decimal> { { "Business", 800M } });
